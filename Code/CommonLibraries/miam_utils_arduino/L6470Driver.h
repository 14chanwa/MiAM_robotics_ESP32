    ...
    namespace miam{
        ...
        class L6470{
            ...
            public:
                ...
                ///            devices.
                void setSpeed(std::vector<float> const& motorSpeeds);
                ...
                void setVelocityProfile(float const& maxSpeed, float const& accel, float const& decel);
                ...
                void moveNSteps(std::vector<float> nSteps);
            ...
            private:
                ...
                uint8_t numberOfDevices_;

                float stepModeMultiplier_; ///< Number of steps in one full step.
        };
    }
#endif
